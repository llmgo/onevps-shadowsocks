...
if [ -f "/etc/init.d/shadowsocks-python" ] || [ -f "/etc/init.d/shadowsocks-r" ] || [ -f "/etc/init.d/shadowsocks-go" ] || [ -f "/etc/init.d/shadowsocks-libev" ] ; then
/root/restart-shadowsocks-all.sh
fi

echo ''
echo 'Note: reference config locations'
echo '/etc/shadowsocks-go/config.json'
echo '/etc/shadowsocks-libev/config.json'
echo '/etc/shadowsocks-python/config.json'
echo '/etc/shadowsocks-r/config.json'
echo ''
echo 'Note: iptables is not enabled by default.  If you will enable iptables edit /etc/iptables/rules.v4 for your chosen port(s)'
